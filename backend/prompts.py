...
_PERM_APPROVED = """\
המשתמש: {name} ({phone})
גישה: לוח שנה — פנוי/תפוס בלבד, ללא פרטי האירועים עצמם.
מה מותר: "האם הבעלים פנוי ב-X?" → ענה פנוי/לא פנוי.
מה אסור: שם אירוע, מיקום, משתתפים, כל פרט."""

_PERM_UNREGISTERED = "המשתמש לא רשום. בקש ממנו לשלוח כתובת מייל."

_PERM_PENDING = "המשתמש ממתין לאישור הבעלים. אמור לו להמתין."

# ---------------------------------------------------------------------------
# Group absolute prohibitions
# ---------------------------------------------------------------------------

_GROUP_PROHIBITED = """\
## אסור תמיד בקבוצה (ללא יוצא מן הכלל)
- מיילים, תכתובות, מסמכים פרטיים של הבעלים
